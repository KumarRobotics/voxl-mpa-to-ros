...
class FailsafeFlags(metaclass=Metaclass_FailsafeFlags):
    ...
    def __init__(self, **kwargs):
        ...
        self.gps_position_invalid = kwargs.get('gps_position_invalid', bool())
    ...
    def __eq__(self, other):
        ...
        if self.global_position_invalid != other.global_position_invalid:
            return False
        if self.gps_position_invalid != other.gps_position_invalid:
            return False
    ...
    @property
    def gps_position_invalid(self):
        """Message field 'gps_position_invalid'."""
        return self._gps_position_invalid

    @gps_position_invalid.setter
    def gps_position_invalid(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'gps_position_invalid' field must be of type 'bool'"
        self._gps_position_invalid = value
