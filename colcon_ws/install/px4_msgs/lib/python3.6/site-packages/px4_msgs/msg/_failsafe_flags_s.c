...
bool px4_msgs__msg__failsafe_flags__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // gps_position_invalid
    PyObject * field = PyObject_GetAttrString(_pymsg, "gps_position_invalid");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->gps_position_invalid = (Py_True == field);
    Py_DECREF(field);
  }
...
PyObject * px4_msgs__msg__failsafe_flags__convert_to_py(void * raw_ros_message)
{
  ...
  {  // gps_position_invalid
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->gps_position_invalid ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "gps_position_invalid", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
