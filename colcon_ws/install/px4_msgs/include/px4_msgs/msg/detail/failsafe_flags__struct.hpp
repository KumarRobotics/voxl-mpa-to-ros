...
struct FailsafeFlags_
{
  ...
  explicit FailsafeFlags_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->gps_position_invalid = false;
  ...
  using _gps_position_invalid_type =
    bool;
  _gps_position_invalid_type gps_position_invalid;
  ...
  Type & set__gps_position_invalid(
    const bool & _arg)
  {
    this->gps_position_invalid = _arg;
    return *this;
  }
  ...
  bool operator==(const FailsafeFlags_ & other) const
  {
    ...
    if (this->gps_position_invalid != other.gps_position_invalid) {
      return false;
    }
