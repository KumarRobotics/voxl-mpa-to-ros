...
public:
  ...
  : msg_(msg)
  {}
  Init_FailsafeFlags_fd_critical_failure flight_time_limit_exceeded(::px4_msgs::msg::FailsafeFlags::_flight_time_limit_exceeded_type arg)
  {
...
class Init_FailsafeFlags_gps_position_invalid
{
public:
  explicit Init_FailsafeFlags_gps_position_invalid(::px4_msgs::msg::FailsafeFlags & msg)
  : msg_(msg)
  {}
  Init_FailsafeFlags_auto_mission_missing gps_position_invalid(::px4_msgs::msg::FailsafeFlags::_gps_position_invalid_type arg)
  {
    msg_.gps_position_invalid = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_FailsafeFlags_gps_position_invalid global_position_invalid(::px4_msgs::msg::FailsafeFlags::_global_position_invalid_type arg)
  {
    msg_.global_position_invalid = std::move(arg);
    return Init_FailsafeFlags_gps_position_invalid(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_FailsafeFlags_mode_req_other mode_req_prevent_arming(::px4_msgs::msg::FailsafeFlags::_mode_req_prevent_arming_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_FailsafeFlags_mode_req_prevent_arming mode_req_home_position(::px4_msgs::msg::FailsafeFlags::_mode_req_home_position_type arg)
  {
